            ...
            <Container maxWidth="lg">
                <Grid container spacing={4} sx={{ textAlign: 'center' }}>
                    <Grid item xs={12} sm={4}>
                        ...
                        <Link href="/terms" sx={{ color: '#337aff', textDecoration: 'none', '&:hover': { color: '#0aa226' } }}>
                            Användarvillkor
                        </Link>
                        <br />
                        <Link
                ...
                <Typography variant="body2" color="textSecondary" align="center" sx={{ marginTop: '20px', transition: 'transform 0.3s ease-in-out',
                    '&:hover': {
                        transform: 'rotate(10deg) scale(1.1)',
                    }}}>
                    © {new Date().getFullYear()} Party Pulse. Alla rättigheter förbehållna.
                </Typography>
            </Container>
        </Box>
    );
